<script lang="ts">
	...
	const friends = [
		{ text: 'General Type', href: 'https://www.generaltypestudio.com/' },
		{ text: 'Atomic Farmer', href: 'https://atomicfarmer.com/' },
		{ text: '', href: 'https://www.fontdue.com/' },
		{ text: 'Dave Lucia', href: 'https://davelucia.com/' },
	];
</script>
